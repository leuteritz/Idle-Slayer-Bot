...
An automation bot for the game [Idle Slayer](https://store.steampowered.com/app/1353080/Idle_Slayer/). It captures the screen, detects game elements via template matching, and automates repetitive actions — key presses, minigames, and SP scanning — through a Tkinter configuration UI.
